...
with open("2020/day-14/example.txt", encoding="utf-8") as f:
    program = f.readlines()
    memory = initialize_memory(program)
    assert 165 == sum(memory.values())


with open("2020/day-14/decoder-example.txt", encoding="utf-8") as f:
    program = f.readlines()
    memory = initialize_decoder(program)
    assert 208 == sum(memory.values())


with open("2020/day-14/input.txt", encoding="utf-8") as f:
    program = f.readlines()
    memory = initialize_memory(program)
