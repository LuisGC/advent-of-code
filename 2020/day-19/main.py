...
with open("2020/day-19/example.txt", encoding="utf-8") as f:
    rules, messages = parse_input(f.read())
    matches = matching_messages(rules, messages)
    assert 2 == sum(matches)


with open("2020/day-19/long-example.txt", encoding="utf-8") as f:
    rules, messages = parse_input(f.read())
    matches = matching_messages(rules, messages)
...
with open("2020/day-19/input.txt", encoding="utf-8") as f:
    rules, messages = parse_input(f.read())
    matches = matching_messages(rules, messages)
