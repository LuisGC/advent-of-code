...
def fix_program (instructions: List[Instruction], line_to_fix: int) -> List[Instruction]:
...
with open("day-08/input.txt") as f:
    ...
    print("Part 2: Removing loops, accumulator is", run_removing_loops(instructions))
